    ...
    <div className="w-[90%] mx-auto h-[15vh]">
      <div className="w-full flex justify-between items-center">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <Link href="#" className='transition ease-in duration-300 hover:scale-105'><Image src={profile} alt="profile" onClick={() => setShowAuthModal(true)} className="shake-on-hover w-[1.5rem] h-[1.5rem] sm:w-[2rem] sm:h-[2rem] transition ease-in duration-300 hover:scale-102"/></Link>
